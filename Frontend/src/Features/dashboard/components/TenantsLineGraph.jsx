...
export default function TenantsLineGraph({
  ...
  return (
    <div className="flex h-full w-full flex-col justify-between rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm">
        ...
        {dropdownOptions?.length ? (
          <div className="relative">
            <button
              ...
              className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-100 px-4 py-2 text-xs font-semibold text-slate-700 transition-all hover:bg-slate-200/70"
            >
              <span>{timeframe}</span>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 z-50 mt-2 w-44 overflow-hidden rounded-2xl border border-slate-200 bg-white py-1 shadow-xl">
                {dropdownOptions.map((option) => (
                  <button
                    ...
                    className={`flex w-full items-center justify-between px-4 py-2.5 text-xs ${
                      timeframe === option ? 'bg-slate-100 font-semibold text-slate-900' : 'text-slate-600 hover:bg-slate-50'
                    }`}
                  >
                    <span>{option}</span>
